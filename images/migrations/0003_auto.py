...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field diagnosis on 'Resource'
        m2m_table_name = db.shorten_name(u'images_resource_diagnosis')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resource', models.ForeignKey(orm[u'images.resource'], null=False)),
            ('term', models.ForeignKey(orm[u'disease_ontology.term'], null=False))
        ))
        db.create_unique(m2m_table_name, ['resource_id', 'term_id'])


    def backwards(self, orm):
        # Removing M2M table for field diagnosis on 'Resource'
        db.delete_table(db.shorten_name(u'images_resource_diagnosis'))
    ...
    models = {
        ...
        u'images.case': {
            ...
            'diagnosis': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['disease_ontology.Term']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['images.Resource']", 'null': 'True', 'blank': 'True'}),
        ...
        u'images.resource': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'default': "'f3da218d-c934-4945-bcac-a50e5d4b3c62'", 'unique': 'True', 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'taggit.tag': {
